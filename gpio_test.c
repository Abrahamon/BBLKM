...
static unsigned int gpioLED = 134;       ///< hard coding the LED gpio for this example PIN 13 (GPIO134)
static unsigned int gpioButton = 133;   ///< hard coding the button gpio for this example PIN 15 (GPIO133)
